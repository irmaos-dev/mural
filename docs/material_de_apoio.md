...
- Um adendo sobre gerenciadores de pacotes
    ...
    Ao fazer essa reinstalação, o gerenciador de pacotes vai usar as versões que estão no arquivo "lock" para baixar as dependências. Caso o arquivo não exista, o gerenciador vai buscar o conjunto de versões mais recentes dos pacotes para baixá-los.
